...
const getSpinner = () => {
	return `
		<svg class="animate-spin installer-spinner ml-1 inline-block align-middle" xmlns="https://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width="16" height="16">
