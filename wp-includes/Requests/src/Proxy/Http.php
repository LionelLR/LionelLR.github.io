...
final class Http implements Proxy {
	 ...
	 *
	 * @since 1.6
	 * @see \WpOrg\Requests\Proxy\https::curl_before_send()
	 * @see \WpOrg\Requests\Proxy\https::fsockopen_remote_socket()
	 * @see \WpOrg\Requests\Proxy\https::fsockopen_remote_host_path()
	 * @see \WpOrg\Requests\Proxy\https::fsockopen_header()
